...
import ModelRetrainingDashboard from "./ModelRetrainingDashboard";
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", color: TXT, background: WHITE, minHeight: "100vh" }}>
      ...
      {page === "ModelRetraining" && <ModelRetrainingDashboard />}
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 40, marginBottom: 48 }}>
            ...
            <div>
              ...
              <p onClick={() => { setPage("ModelRetraining"); window.scrollTo(0,0); }} style={{ fontSize: 12, marginTop: 6, cursor: "pointer", opacity: 0.4 }}>Model retraining</p>
            </div>
            <div>
